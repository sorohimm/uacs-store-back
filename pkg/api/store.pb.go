...
var file_pkg_api_store_proto_rawDesc = []byte{
	...
	0xad, 0x02, 0x0a, 0x10, 0x55, 0x41, 0x43, 0x53, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x87, 0x01, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64,
...
var file_pkg_api_store_proto_depIdxs = []int32{
	0, // 0: github.com.sorohimm.uacs_store.UACSStoreService.GetProduct:input_type -> github.com.sorohimm.uacs_store.ProductRequest
	2, // 1: github.com.sorohimm.uacs_store.UACSStoreService.GetAllProducts:input_type -> github.com.sorohimm.uacs_store.AllProductsRequest
	1, // 2: github.com.sorohimm.uacs_store.UACSStoreService.GetProduct:output_type -> github.com.sorohimm.uacs_store.ProductResponse
	3, // 3: github.com.sorohimm.uacs_store.UACSStoreService.GetAllProducts:output_type -> github.com.sorohimm.uacs_store.AllProductsResponse
