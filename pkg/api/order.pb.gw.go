...
func request_OrderServiceCommander_NewOrder_0(ctx context.Context, marshaler runtime.Marshaler, client OrderServiceCommanderClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Order
...
func local_request_OrderServiceCommander_NewOrder_0(ctx context.Context, marshaler runtime.Marshaler, server OrderServiceCommanderServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Order
	var metadata runtime.ServerMetadata
...
func RegisterOrderServiceCommanderHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrderServiceCommanderServer) error {
	...
	mux.Handle("POST", pattern_OrderServiceCommander_NewOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/github.com.sorohimm.uacs_store.OrderServiceCommander/NewOrder", runtime.WithHTTPPathPattern("/v1/order"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_OrderServiceCommander_NewOrder_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_OrderServiceCommander_NewOrder_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterOrderServiceCommanderHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrderServiceCommanderClient) error {
	...
	mux.Handle("POST", pattern_OrderServiceCommander_NewOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/github.com.sorohimm.uacs_store.OrderServiceCommander/NewOrder", runtime.WithHTTPPathPattern("/v1/order"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_OrderServiceCommander_NewOrder_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_OrderServiceCommander_NewOrder_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "order"}, ""))
)

var (
	forward_OrderServiceCommander_NewOrder_0 = runtime.ForwardResponseMessage
)
